...
class OrderControllerTest {
    ...
    @Test
    void testCompleteOrder_OrderNotFound() throws Exception {
        when(orderService.completeOrder(orderId)).thenThrow(new OrderNotFoundException(orderId));
    ...
    @Test
    void testCompleteOrder_IllegalState() throws Exception {
        when(orderService.completeOrder(orderId)).thenThrow(new IllegalStateException("Cannot complete order"));
